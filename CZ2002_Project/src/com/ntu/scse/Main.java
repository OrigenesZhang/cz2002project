...
public class Main {
	...
	public static void main(String[] args) throws InvalidInfoException {
		...
		do {
			...
			System.out.println("(3) Check/Update ROOM details;");
			System.out.println("(4) Create ROOM SERVICE orders;");
			System.out.println("(5) Create/Update/Remove ROOM SERVICE MENU items;");
			System.out.println("(6) Room CHECK-IN (for WALK-IN or RESERVATION)");
			System.out.println("(7) Room CHECK-OUT and print BILL invoice");
			System.out.println("(8) Print ROOM STATUS statistic report");
			System.out.println("(9) Save to file");	//should not be needed. 
			System.out.println("(10) Exit");
			System.out.println("");
			choice = errorCheckingInt("Enter the number of your choice: ", 10);
			switch (choice) {
